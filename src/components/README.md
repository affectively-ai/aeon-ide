...
Browser-first Aeon IDE container components used by `AeonContainerIDE`.

## Files

- `AeonContainerIDE.tsx` - orchestration container for file tree, editor, console, command UI, actions, and optional room collaboration panel
...
- `CapabilityBadge.tsx` - UCAN tier/capability identity badge
- `revision-history.ts` - revision timeline utilities
- `aeon-container-ide.css` - shared Aeon IDE styling contract
